...
const ProductCard: React.FC<ProductCardProps> = ({ image, item, quantity, cost }) => {
  return (
    <div className="flex flex-row justify-between w-full my-1 text-xs border-b border-dashed border-gray-400 pb-1">
      <Image src={image} alt={item} width={50} height={50} className="object-cover rounded-lg" />
      <div className="flex flex-col w-[270px] justify-start space-y-2 pl-2 pt-1">
